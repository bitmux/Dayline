...
export const ordinary: SpineEntry[] = [
  ...
  { id: "cal:school", start: at(8, 20), kind: "calendar", source: "Google",
    color: "blue", title: "Kid to school",
...
export const busy: SpineEntry[] = [
  ...
  { id: "cal:standup", start: at(9, 0), kind: "calendar", source: "Google",
    color: "blue", title: "Standup" },
  { id: "cal:dentist", start: at(10, 30), kind: "calendar", source: "Google",
    color: "blue", title: "Dentist" },
  { id: "cal:lunch", start: at(12, 0), kind: "calendar", source: "Google",
    color: "blue", title: "Lunch with Dana" },
  {
    id: "todo:laundry",
    start: offset(-38),
    kind: "todo",
  ...
  { id: "cal:pt", start: offset(80), kind: "calendar", source: "Google",
    color: "blue", title: "Physio",
    weather: { condition: "pouring", temperature: 61, precipitation_probability: 90 } },
  { id: "cal:groceries", start: offset(110), kind: "calendar", source: "Google",
    color: "blue", title: "Grocery pickup",
    weather: { condition: "partlycloudy", temperature: 66, precipitation_probability: 15 } },
  { id: "cal:call", start: offset(140), kind: "calendar", source: "Google",
    color: "blue", title: "Call with Marcus",
    weather: { condition: "sunny", temperature: 68, precipitation_probability: 0 } },
  { id: "cal:dinner", start: offset(170), kind: "calendar", source: "CalDAV",
    color: "teal", title: "Making dinner for house", automation: "Kitchen 90%, hallway 40%" },
  { id: "cal:soccer", start: offset(200), kind: "calendar", source: "Google",
    color: "blue", title: "Soccer practice pickup", tags: ["Quiet"], tag_state: "will_fire",
    weather: { condition: "windy", temperature: 59, precipitation_probability: 20 } },
  { id: "cal:book", start: offset(230), kind: "calendar", source: "Google",
    color: "blue", title: "Book club" },
...
export const overlapping: SpineEntry[] = [
  ...
  { id: "cal:standup", start: at(9, 0), end: at(9, 15), kind: "calendar", source: "Google",
    color: "blue", title: "Standup" },
  ...
  { id: "cal:quick", start: offset(120), end: endAfter(120, 30), kind: "calendar", source: "Google",
    color: "blue", title: "Vet call" },
